...
`define WriteDisable 1'b0//写使能取消
`define WriteEnable_low 1'b0//写使能
`define WriteDisable_low 1'b1//写使能取消
`define     WriteEnable_n   1'b0            //写使能（低有效）
`define     WriteDisable_n  1'b1            //写除能（高有效）
`define ReadEnable 1'b1//读使能
`define ReadDisable 1'b0//读使能取消
`define AluOpBus 7:0//译码输出aluop_o的宽度
`define AluSelBus 2:0//译码输出alusel_o的宽度
...
`define InstMemNum 131071//rom实际大小（此处为128KB）

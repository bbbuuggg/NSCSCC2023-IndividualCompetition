...
#
# Generated by export_simulation on Mon Aug 14 00:23:50 +0800 2023
#
################################################################################
...
'-reset_run' switch to the './mult_gen_0.sh' script.

./mult_gen_0.sh -reset_run
...
./mult_gen_0.sh -noclean_files

For more information on the script, please type './mult_gen_0.sh -help'.
